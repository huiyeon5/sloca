<%-- 
    ...
    Created on : 28 Sep, 2017, 5:30:00 PM
...
<html>
    ...
    <body> 
        ...
        <form action="UploadServlet"  method="post" enctype="multipart/form-data" onsubmit="return Validate(this);">
            Filename:
            <input type="file" name="bootstrapFile" accept="application/zip,applbootstrap-fileication/x-zip,application/x-zip-compressed,application/octet-stream"/>
            <br><br>
            <input type="submit" name="functionType" value="Update"/>  
        </form>
